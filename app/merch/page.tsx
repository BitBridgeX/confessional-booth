...
const ALL_PRODUCTS: Product[] = [
  ...
  { id: "s3", name: "Cookie Mami Portrait Print", price: 19.99, category: "Stickers & Prints", subcategory: "Prints", icon: "🖼️", description: "8x10 premium matte finish" },
  ...
  { id: "s5", name: "\"Sin City\" Poster", price: 24.99, category: "Stickers & Prints", subcategory: "Prints", icon: "🖼️", description: "24x36 glossy concert poster" },
  { id: "s6", name: "Confessional Booth Art Print", price: 29.99, category: "Stickers & Prints", subcategory: "Prints", icon: "🖼️", badge: "LIMITED", description: "Signed & numbered, 100 edition" },
  ...
  { id: "s11", name: "\"Repent\" Neon Sign Print", price: 34.99, category: "Stickers & Prints", subcategory: "Prints", icon: "🖼️", description: "LED neon effect, 16x20" },
  ...
  { id: "s14", name: "Gothic Cross Art Print", price: 22.99, category: "Stickers & Prints", subcategory: "Prints", icon: "🖼️", description: "Dark gothic aesthetic, 11x14" },
  ...
  { id: "s17", name: "Confessional Photo Set", price: 14.99, category: "Stickers & Prints", subcategory: "Prints", icon: "🖼️", description: "Set of 5 polaroid-style prints" },
  { id: "s18", name: "\"Sinners Welcome\" Door Sign", price: 12.99, category: "Stickers & Prints", subcategory: "Prints", icon: "🖼️", description: "Acrylic hanging sign" },
  ...
  { id: "s20", name: "Cookie Mami Calendar", price: 19.99, category: "Stickers & Prints", subcategory: "Prints", icon: "🖼️", badge: "NEW", description: "12 months of sin & sass" },
  ...
  { id: "t4", name: "Velvet Restraint Set", price: 44.99, category: "Adult Toys & Pleasure", subcategory: "Bondage", icon: "⛓️", description: "Wrist + ankle cuffs, velvet" },
  { id: "t5", name: "\"Repent\" Paddle", price: 29.99, category: "Adult Toys & Pleasure", subcategory: "Bondage", icon: "⛓️", badge: "ICONIC", description: "Leather paddle, leaves 'REPENT' imprint" },
  { id: "t6", name: "Satin Blindfold", price: 14.99, category: "Adult Toys & Pleasure", subcategory: "Bondage", icon: "⛓️", description: "Black satin, adjustable" },
  ...
  { id: "t9", name: "Bondage Rope Set (3 colors)", price: 22.99, category: "Adult Toys & Pleasure", subcategory: "Bondage", icon: "⛓️", description: "Soft cotton, 30ft each" },
  { id: "t10", name: "\"Pray Position\" Kneeling Pad", price: 34.99, category: "Adult Toys & Pleasure", subcategory: "Bondage", icon: "⛓️", description: "Memory foam, washable cover" },
  ...
  { id: "t13", name: "Feather Tickler", price: 12.99, category: "Adult Toys & Pleasure", subcategory: "Bondage", icon: "⛓️", description: "Ostrich feather, long handle" },
  ...
  { id: "t15", name: "Collar & Leash Set", price: 34.99, category: "Adult Toys & Pleasure", subcategory: "Bondage", icon: "⛓️", description: "Faux leather, gold hardware" },
  ...
  { id: "t20", name: "Under-Bed Restraint System", price: 39.99, category: "Adult Toys & Pleasure", subcategory: "Bondage", icon: "⛓️", description: "4-point, adjustable straps" },
  ...
  { id: "f6", name: "Cookie Mami Hot Sauce", price: 14.99, category: "Food Products", subcategory: "Gourmet", icon: "🌶️", description: "\"Hellfire\" blend, limited batch" },
  ...
  { id: "d3", name: "Podcast Script Bundle", price: 19.99, category: "Digital Products", subcategory: "Scripts", icon: "🎙️", description: "10 episode scripts, Cookie Mami voice" },
  ...
  { id: "d9", name: "Scripture Wallpaper Pack", price: 3.99, category: "Digital Products", subcategory: "Books", icon: "🖼️", description: "20 phone/desktop wallpapers" },
